...
c1 "$(row 'Super+Y'        'Yazi')"
c1 "$(row 'Super+B'        'Brave')"
c1 "$(row 'Super+P'        'Spotify')"
c1 "$(row 'Super+T'        'btop')"
c1 "$(row 'Super+E'        'spf')"
c1 "$(row 'Super+Shift+I'  'Toggle iPad display')"
c1 "$(row 'Super+Shift++ / -'  'iPad: subir/bajar resolución')"
c1 "$(row 'Super+Shift+Ctrl+I'  'iPad: menú tamaño')"
c1 "$(row 'Super+C'        'Cerrar ventana')"
c1 "$(row 'Super+F'        'Fullscreen')"
